...
const uniforms = {
  ...
  iRotate:{value:new THREE.Vector3()},
  iShadows: {value: 1}
};
...
function render(time) {
        ...
        ContinuesTime += map_range(lowpass,0,140,0.0,.07);//REMAP INPUT VALUE
        uniforms.iSpeed.value = ContinuesTime * folder2.controllers[1].object.SpeedOfMotion;
